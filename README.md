...
This project focuses on image processing and classification using TensorFlow and ResNet50. It includes handling .zip files, extracting images, and evaluating model performance using precision, recall, and F1-score.
